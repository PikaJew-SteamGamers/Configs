...
If you wish to create your own EntWatch files, this help file should guide you as well as has a few examples: https://github.com/Frozen-H2O/Configs/blob/master/Entwatch%20Files/Entwatch%20template%20with%20help.cfg
If you wish to create your own Map Stripper files, the documentation for it can be found here: http://bailopan.net/strippers